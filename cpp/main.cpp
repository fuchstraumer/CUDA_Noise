...
int main() {
	...
	Billow2D subject0(img_size, img_size, noise_t::PERLIN, 1.0f, 1.0f, 2342, 0.05f, 1.5f, 7, 1.5f);
	Billow2D subject1(img_size, img_size, noise_t::PERLIN, 1.0f, 1.0f, 22312451, 0.05f, 1.5f, 7, 1.5f);
	Billow2D selector(img_size, img_size, noise_t::PERLIN, 5.0f, 1.0f, 2411, 0.025f, 1.5f, 4, 1.5f);
	subject0.Generate();
	subject1.Generate();
	selector.Generate();
